"""
Safety Helmet Detection Web Application (Simplified Version)
==========================================================

A Streamlit web application for detecting safety helmets in images using YOLOv8.
This simplified version works without OpenCV for initial deployment testing.
...
if uploaded_file is not None and model is not None:
    try:
        ...
        if results and len(results) > 0:
            ...
            # Get the annotated image (this should work without OpenCV)
